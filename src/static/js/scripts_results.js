...
votes_day = {
    ...
    edison: [0,	5,	6,	11,	14,	14,	15,	17,	20,	20,	20,	20,	20,	21,	25,	25,	26,	27,	28,	28,	29,	29,	29],
    juan: [ 0,	3,	7,	14,	15,	17,	23,	25,	29,	29,	30,	30,	30,	33,	33,	36,	36,	38,	39,	39,	39,	40,	42],
    genaldo: [0,	4,	7,	64,	87,	87,	89,	90,	92,	95,	95,	95,	96,	97,	98,	100,	101,	101,	106,	108,	108,	109,	109],
    mikan: [0,	3,	14,	24,	30,	34,	35,	38,	42,	42,	42,	42,	42,	43,	44,	46,	47,	47,	48,	48,	48,	49,	51],
    blanca: [ 0,	10,	22,	29,	35,	38,	38,	38,	95,	98,	98,	98,	98,	100,	100,	102,	105,	107,	112,	115,	115,	117,	118],
    voto_blanco: [    1,	1,	1,	1,	2,	2,	2,	2,	2,	2,	2,	2,	2,	3,	3,	3,	3,	3,	3,	3,	3,	3,	3],
}
...
const percentageValues = [34, 31, 14, 12, 8, 1];
